...
// The previous import block here listed SDK models under VRPaymentPayment\Sdk, which is
...
class CheckoutSubscriber implements EventSubscriberInterface
{
     ...
     */
    private const POSSIBLE_METHODS_CACHE_PREFIX = 'vrpn_possible_methods_';
	...
	/**
	 * Updates the VRPayment transaction when the payload that would be sent differs from
