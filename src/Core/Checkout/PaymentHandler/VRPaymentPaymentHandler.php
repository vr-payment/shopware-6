...
use VRPaymentPayment\Core\Util\Payload\PayloadLimits;
...
class VRPaymentPaymentHandler extends AbstractPaymentHandler
{
    ...
    public function pay(
        ...
        try {
            ...
            if ($orderTransaction->getOrder()->getAmountTotal() > 0) {
                ...
                $request->getSession()->set('vrpaymentActivePaymentOrderId', $orderId);
            }
    ...
    public function finalize(
        ...
        if ($request->hasSession()) {
            $request->getSession()->remove('vrpaymentActivePaymentOrderId');
        }
