...
class TransactionService
{
     ...
     */
    public const FILTER_MEMO_EXTENSION = 'vrpayment_filter_memo';

    /**
     * Cache key prefix for the persisted pending transaction record.
     */
    private const PENDING_TRANSACTION_CACHE_PREFIX = 'vrpn_pending_transaction_v2_';
    ...
    private function extractShippingLineItem(
        ...
        $shippingLineItem->setAmountIncludingTax($roundedAmount)
            ->setName($this->fixLength($shippingName . ' ' . ($translator ? $translator->trans('vrpayment.payload.shipping.lineItem') : 'Shipping'), PayloadLimits::LINE_ITEM_NAME))
