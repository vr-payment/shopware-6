...
namespace VRPaymentPayment\Core\Util\Payload\CustomFields;
...
class ProductCustomFieldAttributeService
{
    ...
    /**
     *
     * @return array<string, array<string, \VRPayment\Sdk\Model\LineItemAttributeCreate>>
     *
     * @throws \VRPaymentPayment\Core\Util\Exception\InvalidPayloadException
     */
